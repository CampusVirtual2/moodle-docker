...
class __Mustache_d69b2132b36c4016a1108a96f4804bce extends Mustache_Template
{
...
';
        ...
        $value = $context->find('addgradeitembutton');
        $buffer .= $this->section70ca5ebf3bbf4ac267b7c72061ad6a93($context, $indent, $value);
        $value = $context->find('addoutcomeitembutton');
        $buffer .= $this->section70ca5ebf3bbf4ac267b7c72061ad6a93($context, $indent, $value);
        $value = $context->find('addcategorybutton');
        $buffer .= $this->section70ca5ebf3bbf4ac267b7c72061ad6a93($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
