...
class __Mustache_ac292a5d278cb382c78d82612090cae5 extends Mustache_Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<footer id="page-footer-unb" class="p-y-1">
';
...
';
        $buffer .= $indent . '          <img src="/theme/moove/pix/unb/logo_campus_virtual.png" class="footer-logo logo-campusvirtual">
';
        $buffer .= $indent . '          <img src="/theme/moove/pix/unb/logo_latitude.png" class="footer-logo logo-latitude">
';
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '
