...
$string['confirmrevoke'] = 'Revogar todos os compromissos no período atual?';
...
$string['divide'] = 'Dividir em períodos?';
$string['duration'] = 'Duração';
$string['durationrange'] = 'Duração do período deve estar entre {$a->min} e {$a->max} minutos.';
...
$string['email_invite_html'] = '<p>Por favor escolha um período de tempo para um compromisso em:</p> <p>{$a->scheduler_url}</p>';
$string['email_invite_subject'] = 'Convite: {$a->module}';
$string['email_invitereminder_html'] = '<p>Este é um lembrete de que você ainda não agendou seu compromisso. Por favor, escolha um período de tempo assim que possível em:</p><p>{$a->scheduler_url}</p>';
...
<p><strong><span class="error">foi cancelado</span></strong>. Por favor, solicite um novo período.</p>';
...
foi cancelado. Por favor, solicite por um novo período.';
...
$string['end'] = 'Fim';
$string['enddate'] = 'Repetir períodos de tempo até';
...
$string['event_slotadded'] = 'Período adicionado';
$string['event_slotdeleted'] = 'Período excluído';
$string['everyone'] = 'Todos';
$string['excelformat'] = 'Excel';
$string['exclusive'] = 'Exclusivo';
$string['exclusivity'] = 'Exclusividade';
$string['exclusivity_help'] = '<p>Você pode definir um limite no número de estudantes que podem solicitar um determinado período. </p>
<p>Definindo um limite de 1 (padrão) significará que o período é exclusivo para um único estudante.</p>
<p>Definindo um limite de, por exemplo, 3, significará que até três estudantes podem agendar o período.</p>
<p>Se desabilitado, qualquer número de estudantes pode agendar o período; ele nunca será considerado "cheio".</p>';
$string['exclusivityoverload'] = 'O período possui {$a} estudantes agendados, mais que o permitido por essa configuração.';
$string['exclusivitypositive'] = 'O número de estudantes por período precisa ser no mínimo 1.';
...
$string['exporthdr'] = 'Exportar períodos e compromissos';
$string['exporttimerange'] = 'Intervalo de tempo';
$string['exporttimerangeall'] = 'Períodos futuros e passados';
$string['exporttimerangefuture'] = 'Somente períodos futuros';
$string['exporttimerangepast'] = 'Somente períodos passados';
...
$string['field-slotnotes'] = 'Anotações do período';
...
$string['firstslotavailable'] = 'O primeiro período será aberto em: {$a}';
$string['forbidgroup'] = 'Período de grupo - clique para alterar';
$string['forcewhenoverlap'] = 'Forçar quando coincidir';
$string['forcewhenoverlap_help'] = '<h3>Forçar criação de períodos quando os períodos coincidirem</h3>
<p>Essa configuração determina como os novos períodos serão tratados se eles coincidirem com períodos já existentes.</p>
<p>Se habilitado,  o período existente será removido e o novo período será criado.</p>
<p>Se desabilitado, o período existente será mantido e um novo período  <em>não</em> será criado.</p>';
...
$string['groupbookings_help'] = 'Permitir aos estudantes agendarem um período para todos os membros de seu grupo.
(Note que isso é separado da configuração "modo grupo", que controla os períodos que um estudante pode ver.)';
...
$string['guardtime_help'] = 'Um tempo de proteção impede que os estudantes alterem sua reserva um pouco antes do compromisso.
 <p>Se o tempo de guarda estiver habilitado e definido para, por exemplo, 2 horas, os estudantes não poderão agendar um horário que comece em menos de 2 horas a partir de agora., e eles não poderão cancelar um compromisso se iniciar em menos de 2 horas. </p>';
...
$string['ignoreconflicts'] = 'Ignorar conflitos de agendamento';
$string['ignoreconflicts_help'] = 'Se esta opção estiver assinalada, então o período será movido para a data e hora solicitada, mesmo se existirem outros períodos no mesmo horário. Isso pode gerar paridade de compromissos para alguns professores ou estudantes, e deve, portanto, ser usada com cuidado.';
$string['ignoreconflicts_link'] = 'mod/scheduler/conflict';
$string['includeemptyslots'] = 'Incluir períodos vazios';
$string['includeslotsfor'] = 'Incluir períodos para';
...
$string['on'] = 'em';
$string['onedaybefore'] = '1 dia antes do período';
$string['onelineperappointment'] = 'Uma linha por compromisso';
$string['onelineperslot'] = 'Uma linha por período';
