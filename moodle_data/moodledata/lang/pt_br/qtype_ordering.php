...
$string['yougotnincorrect'] = 'Você tem {$a->numincorrect} {$a->numincorrectplural} incorretos.';
$string['yougotnpartial'] = 'Você tem {$a->numpartial} {$a->numpartialplural} parcialmente corretos.';
$string['yougotnright'] = 'Você tem {$a->numright} {$a->numrightplural} corretos.';
