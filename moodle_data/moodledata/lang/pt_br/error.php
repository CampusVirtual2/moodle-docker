...
$string['callbackrejectcomment'] = 'O comentário de retorno rejeitou este comentário.';
$string['cannotaddcoursemodule'] = 'Não foi possível adicionar um novo módulo ao curso.';
...
$string['cannotaddrss'] = 'Você não tem autorização para adicionar alimentadores de notícias RSS';
...
$string['cannotdeletecustomfield'] = 'Erro ao excluir dados de campo personalizado';
...
$string['cannotopentemplate'] = 'Não é possível abrir o arquivo de referência (template) {$a}';
...
$string['cannotsaveagreement'] = 'Não foi possível salvar seu acordo';
...
$string['cannotsetprefgrade'] = 'Não foi possível definir a preferência aggregationview como {$a} para esta categoria de nota.';
...
$string['csvinvalidcols'] = '<b>Arquivo CSV inválido:</b> A primeira linha deve incluir "Campos de Cabeçalho" e o arquivo deve ser do tipo <br />"Campos Expandidos/Separados por Vírgula"<br />ou<br />"Campos Expandidos com Código de Resultado CAVV/Separados por Vírgula"';
...
$string['ddlunknownerror'] = 'Erro desconhecido na biblioteca DDL';
...
$string['destinationcmnotexit'] = 'O módulo de curso de destino não existe';
...
$string['duplicateroleshortname'] = 'Existe um papel com esse mesmo nome curto!';
...
$string['error_question_answers_missing_in_db'] = 'Não foi possível encontrar uma resposta correspondente à "{$a->answer}" na tabela question_answers da base de dados. Ocorreu ao restaurar a questão com o id {$a->filequestionid} do arquivo de cópia de segurança, que correspondia à questão existente com o id {$a->dbquestionid} na base de dados.';
...
$string['externalauthpassworderror'] = 'Senha não pode ser vazia para autenticação externa';
...
';
$string['filenotfound'] = 'Desculpe, o arquivo não foi encontrado';
...
$string['invalidargorconf'] = 'Nenhum argumento válido fornecido ou configuração de servidor incorreta.';
$string['invalidarguments'] = 'Nenhum argumento válido fornecido';
...
$string['invalidcommentitemid'] = 'ID de item do comentário é inválido';
$string['invalidcommentparam'] = 'Parâmetros de comentário inválidos';
...
$string['invalidusername'] = 'A identificação de usuário fornecida contém caracteres inválidos';
