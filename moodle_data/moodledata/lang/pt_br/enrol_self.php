...
$string['expirymessageenrolledsubject'] = 'Notificação de expiração da auto-inscrição';
...
Se você ainda não fez, edite sua página de perfil para que possamos saber mais sobre você:
