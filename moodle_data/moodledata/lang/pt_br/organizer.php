...
$string['btn_deleteappointment'] = 'Excluir compromisso';
...
$string['cfg_dontshowidentity_desc'] = 'Ocultar identidade dos participantes na lista de intervalo';
$string['cfg_limitedwidth'] = 'Área de conteúdo menor';
$string['cfg_limitedwidth_desc'] = 'Use uma área de conteúdo menor no estilo do Moodle 4.x no Organizer. O padrão do Moodle é utilizado, mas pode ser esticado por entradas longas na tabela.';
...
$string['configlocationslist'] = 'Locais para o campo de autocompletar';
$string['configlocationslist_desc'] = 'Cada localização deve ser inserida em uma linha separada';
...
$string['configsingleslotprintfield'] = 'campo do usuário a ser impresso quando um único intervalo for impresso';
$string['configweek'] = 'semana';
$string['configweeks'] = 'semanas';
$string['configyear'] = 'ano';
$string['confirm_conflicts'] = 'Você tem certeza de que deseja ignorar as colisões e criar os intervalos de tempo?';
...
$string['datetime_help'] = 'Data e Hora do intervalo';
$string['day'] = 'dia';
...
$string['day_pl'] = 'dias';
$string['dbid'] = 'DB ID';
$string['defaultsingleslotprintfields'] = 'Campos de perfil do usuário para slot único de impressão padrão';
$string['delete_organizer_grades'] = 'Removendo notas de todos os organizadores';
$string['deleteappointmentheader'] = 'Excluir este compromisso';
...
$string['details_help'] = 'Status atual deste intervalo';
$string['downloadfile'] = 'Baixar arquivo';
$string['duedate'] = 'Data de entrega';
$string['duedateerror'] = 'Prazo final absoluto não pode ser definido antes da data de disponibilidade!';
$string['duration'] = 'Duração';
$string['duration_help'] = 'Define a duração dos agendamentos. Todos os intervalos de tempo definidos serão divididos em blocos com a duração estabelecida aqui. Qualquer tempo restante permanecerá não utilizado (ou seja, se o intervalo de tempo for de 40 minutos e a duração for definida como 15 minutos, haverá 2 blocos no total, com 10 minutos extras não utilizados).';
$string['edit_submit'] = 'Confirmar alterações';
$string['emailteachers'] = 'Enviar notificações para os professores';
$string['emailteachers_help'] = 'Notificações para professores quando um estudante se registra pela primeira vez em um horário geralmente são suprimidas para evitar spam. Marque esta opção para permitir que o organizador envie tais notificações por e-mail aos professores. Observe que as notificações para cancelar o registro e alterar horários são sempre enviadas.';
$string['enableprintslotuserfields'] = 'Permitir alteração nos campos personalizados do usuário';
$string['enableprintslotuserfieldsdesc'] = 'Controla se os professores têm permissão para alterar os campos de perfil do usuário selecionados por padrão abaixo.';
$string['err_availablefromearly'] = 'Essa data não pode ser definida após a data de início!';
$string['err_availablefromlate'] = 'Essa data não pode ser definida após a data final!';
$string['err_availablepastdeadline'] = 'Este slot não pode ser disponibilizado após o prazo limite do agendador ({$a->deadline})!';
$string['err_collision'] = 'Este frame está em colisão com outros frames:';
$string['err_comments'] = 'Você deve inserir uma descrição!';
$string['err_enddate'] = 'A data final não pode ser definida antes da data de início!';
$string['err_fromto'] = 'O horário de término não pode ser definido antes do horário de início!';
$string['err_fullminute'] = 'A duração deve ser de um minuto completo.';
$string['err_fullminutegap'] = 'A diferença deve ser de um minuto completo.';
$string['err_isgrouporganizer_app'] = 'Não é possível alterar o modo de grupo, pois já existem agendamentos marcados neste Organizer!';
$string['err_location'] = 'Você deve inserir uma localização!';
$string['err_norecipients'] = 'Nenhum destinatário foi selecionado!';
$string['err_noslots'] = 'Nenhum slot foi selecionado!';
