...
Alguém (provavelmente você) solicitou uma nova senha para sua conta no site \'{$a->sitename}\'.

Infelizmente, sua conta neste site está desativada, então a senha não pode ser redefinida. Por favor, entre em contato com o administrador do site {$a->admin}.';
$string['emailpasswordchangeinfofail'] = 'Olá, {$a->firstname},

Alguém (provavelmente você) solicitou uma nova senha para sua conta no site \'{$a->sitename}\'.

Infelizmente, as senhas não podem ser redefinidas neste site. Por favor, entre em contato com o administrador do site {$a->admin}.';
...
$string['preferredlanguage'] = 'Preferência de idioma';
...
$string['selectacoursesite'] = 'Selecione um curso ou site';
