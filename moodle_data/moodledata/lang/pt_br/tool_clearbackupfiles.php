...
$string['continuetoclearbackup'] = 'Continue para limpeza de backup';
$string['coursebackupremoved'] = 'Backup do curso excluído';
$string['crontask'] = 'Tarefa de limpeza de arquivos de backup (.mbz)';
$string['days'] = 'Dias';
$string['daysdesc'] = 'Número de dias para limpeza de backup';
